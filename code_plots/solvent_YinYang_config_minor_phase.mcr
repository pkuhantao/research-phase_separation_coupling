...
### Here we define the minor phase is the region with psi < 0
...
$!READDATASET  '"|MFBD||Folder||Datafolder|/inSolv_Yang_and_center_psi_|Index|.dat" '
  READDATAOPTION = NEW
  RESETSTYLE = YES
  INCLUDETEXT = NO
  INCLUDEGEOM = NO
...
$!READDATASET  '"|MFBD||Folder||Datafolder|/inSolv_Yin_and_center_psi_|Index|.dat" '
...
$!FIELDMAP [1-2]  SURFACES{SURFACESTOPLOT = EXPOSEDCELLFACES}
$!FIELDLAYERS SHOWCONTOUR = YES
...
$!GLOBALCONTOUR 1  COLORCUTOFF{INCLUDEMAX = YES}
$!GLOBALCONTOUR 1  COLORCUTOFF{RANGEMAX = 0}
$!REDRAWALL 
...
$!EXPORTSETUP EXPORTFNAME = '|MFBD||Folder||Picsfolder|/inSolv_YinYang_psi_minor_phase_|Index|.png'
$!EXPORT 
