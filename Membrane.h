...
public:
    ...
    void calcMu_dw_cp(const InnerSolvPatch* inSolv_Yin, const InnerSolvPatch* inSolv_Yang); // calculate mu from double well potential and the local coupling with the inner solvent
